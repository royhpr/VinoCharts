...
-(void)setTextColorGZColorString:(NSString*)GZColorHexValue; //temporary TODO fix. Civics wasn't able to implement saving UIColor objects.
-(UIColor*)getTextColor;
-(NSString*)getTextColorGZColorString;//temporary TODO fix. Civics wasn't able to implement saving UIColor objects.
