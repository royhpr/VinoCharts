...
//Notes,material
FOUNDATION_EXPORT NSString* NOTE_DEFAULT_MATERIAL;
...
//Notes,font
FOUNDATION_EXPORT CGFloat NOTE_DEFAULT_FONT_SIZE;
FOUNDATION_EXPORT NSString* NOTE_DEFAULT_FONT;
FOUNDATION_EXPORT NSString* NOTE_DEFAULT_FONT_COLOR;

//Canvas Window
FOUNDATION_EXPORT NSUInteger CANVAS_WINDOW_UNPLACED_FRESH_NOTE_LIM;
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_MAX; //tier 6
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_TIER5_UPPER_LIM;
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_TIER4_UPPER_LIM;
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_TIER3_UPPER_LIM;
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_TIER2_UPPER_LIM;
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_TIER1_UPPER_LIM;
FOUNDATION_EXPORT double CANVAS_WINDOW_ZOOMSCALE_MIN;

//Grid
FOUNDATION_EXPORT NSUInteger GRID_TIER6_STEPPING;
FOUNDATION_EXPORT NSUInteger GRID_TIER5_STEPPING;
FOUNDATION_EXPORT NSUInteger GRID_DEFAULT_STEPPING; //tier 4
FOUNDATION_EXPORT NSUInteger GRID_TIER3_STEPPING;
FOUNDATION_EXPORT NSUInteger GRID_TIER2_STEPPING;
FOUNDATION_EXPORT NSUInteger GRID_TIER1_STEPPING;

//Minimap
FOUNDATION_EXPORT int MINIMAP_DEFAULT_FRAME_ORIGIN_X;
FOUNDATION_EXPORT int MINIMAP_DEFAULT_FRAME_ORIGIN_Y;
FOUNDATION_EXPORT int MINIMAP_DEFAULT_BOUNDS_SIZE_WIDTH;
FOUNDATION_EXPORT int MINIMAP_DEFAULT_BOUNDS_SIZE_HEIGHT;
...
FOUNDATION_EXPORT NSUInteger CANVAS_DEFAULT_WIDTH;
FOUNDATION_EXPORT NSUInteger CANVAS_DEFAULT_HEIGHT;
FOUNDATION_EXPORT NSString* CANVAS_DEFAULT_COLOR_IN_GZCOLORHEXVALUE;
...
//Diagram Title
FOUNDATION_EXPORT NSUInteger DIAGRAM_TITLE_CHAR_LIM;
FOUNDATION_EXPORT NSUInteger DIAGRAM_TITLE_DEFAULT_TOP_OFFSET;
...
extern const int MAX_LINE_BREAKS;
