...
-(void) colorPopoverControllerDidSelectColor:(NSString *)hexColor{
    ...
    [_delegate CanvasSettingControllerDelegateTappedGZColorHexValue:hexColor]; //TODO temporary. Civics was unable to implement saving of UIColor.
}
...
#pragma mark - UIAlert Arbiter

-(void)alertView:(UIAlertView *)alertView willDismissWithButtonIndex:(NSInteger)buttonIndex
{
    // This function caters to a UIAlert that is summoned when notes will be disrupted by canvas resizing.
    // UIAlert says something along the lines of:
    // <msg>
    // X notes will be disrupted by canvas resizing.
    // These X notes under unplaced notes button.
    ...
    {
        [_delegate CanvasSettingControllerDelegateChangeCanvas:_passedWidth :_passedheight strandedNotesAt:_passedIndicesOfAffectedNotes];
    }
}
