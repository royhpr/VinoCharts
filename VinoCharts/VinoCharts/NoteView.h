...
@property (readwrite, nonatomic) NSString* textColorGZColorString;//TODO temp fix Civics wasn't able to implement saving UIColor objects.
...
-(NSString*)getTextColorGZColorString;//TODO temp fix. Civics wasn't able to implement saving UIColor objects.
...
-(double)getMinYOfContent; //TODO WILL BE DEPRECATED IN A REFACTOR
